                ...
                <table class="table table-light table-borderless table-hover text-center mb-0">
                    ...
                    <tbody class="align-middle">
                        <c:forEach items="${cartDetails}" var="cartDetail">
                            <tr>
                                <td class="align-items-start"><img src="/images/product/${cartDetail.product.image}" alt="" style="width: 50px;"> ${cartDetail.product.name}</td>
                                <td class="align-items-start">${cartDetail.price} Đ</td>
                                ...
                                <td class="align-middle">${cartDetail.price} Đ</td>
